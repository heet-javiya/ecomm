...
export const AddressForm: React.FC<Props> = ({ initialData = null, onCancel, onSave }) => {
    ...
    function handleSubmit(e?: React.FormEvent) {
        e?.preventDefault();
        const payload: Omit<Address, "id"> & Partial<Pick<Address, "id">> = { ...form } as Omit<Address, "id"> & Partial<Pick<Address, "id">>;
        // Remove undefineds
    ...
    return (
        <form onSubmit={handleSubmit} className="">
            ...
            <div className="mt-6 flex gap-4">
                ...
                <button type="button" onClick={onCancel} className="bg-white border border-gray-300 px-6 py-2 rounded-md">
                    Discard
                </button>
            </div>
        </form>
